...
void main() {
  ...
  var baseExpectedFilePath =
      path.join('lib', 'src', 'generated', '$baseClassFileName.dart');
  var baseTableName = 'example_table';
  ...
  var subTableName = 'sub_example_table';
  ...
  group('Given a class with table name when generating code', () {
    ...
    var maybeClassNamedExampleTable =
      ...
      compilationUnit,
      name: '${baseClassName}Table',
    );

    test('then a class named ${baseClassName}Table is generated.', () {
      expect(
        maybeClassNamedExampleTable,
        isNotNull,
        reason: 'Missing definition for class named ${baseClassName}Table',
      );
    });
    group('then the class named ${baseClassName}Table', () {
      ...
      test(
        ...
        expect(
            CompilationUnitHelpers.hasConstructorDeclaration(
              ...
              superArguments: ['tableName: \'$baseTableName\''],
            ),
            isTrue,
            reason:
                'Missing declaration for $baseClassName constructor with nullable id field passed to super.');
      });
  ...
  group(
    ...
    group('then the class named ${baseClassName}Table', () {
      ...
      test('has field included in columns.', () {
        ...
        skip: maybeClassNamedExampleTable == null
            ? 'Could not run test because ${baseClassName}Table class was not found'
            : false);
  });
  ...
  group(
    ...
    test(
        'then the class named ${baseClassName}Table has a getRelationTable method.',
        () {
      expect(
          CompilationUnitHelpers.hasMethodDeclaration(
            maybeClassNamedExampleTable!,
  ...
  group(
    ...
    group(
        'then the class named ${baseClassName}Table has many relation private field.',
        () {
